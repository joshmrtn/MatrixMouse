...
- [x] LLM backend flexibility ([#10](../../issues/10))
...
- [ ] Multi-worker orchestration ([#15](../../issues/15))
- [ ] Expanded language support ([#18](../../issues/18), [#20](../../issues/20))
- [ ] Plugins system ([#19](../../issues/19), [#21](../../issues/21))
- [ ] Web search tool for all agents ([#22](../../issues/22))
- [ ] RAG pipeline ([#23](../../issues/23))
